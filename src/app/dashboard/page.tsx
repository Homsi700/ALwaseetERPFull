      ...
      <div className="space-y-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300 border-l-4 border-primary">
            ...
            <CardContent>
              <div className="text-3xl font-bold font-headline text-foreground">٤٥٬٢٣١٫٨٩ ل.س</div>
        ...
        <div className="grid gap-6 md:grid-cols-1 lg:grid-cols-2">
           <Card className="shadow-lg">
            ...
            <CardContent className="h-[300px] p-0">
                <ChartContainer config={chartConfig} className="w-full h-full">
                    <RechartsBarChart data={topProductsData} layout="horizontal" margin={{ top: 20, right: 30, left: 0, bottom: 5 }}>
          ...
          <CardContent className="p-0">
            <div className="bg-card-foreground/5 text-foreground h-14 flex items-center">
              <div className="whitespace-nowrap animate-marquee">
                <span className="mx-6 text-sm">منتج أ: <span className="font-code text-green-500">١٠٫٥٠ ل.س <TrendingUp className="inline h-4 w-4" /></span></span>
                <span className="mx-6 text-sm">منتج ب: <span className="font-code text-red-500">٢٢٫٣٠ ل.س <TrendingUp className="inline h-4 w-4 transform rotate-180" /></span></span>
                <span className="mx-6 text-sm">منتج ج: <span className="font-code text-green-500">٥٫٧٥ ل.س <TrendingUp className="inline h-4 w-4" /></span></span>
                <span className="mx-6 text-sm">منتج د: <span className="font-code text-green-500">١٠٢٫٠٠ ل.س <TrendingUp className="inline h-4 w-4" /></span></span>
                <span className="mx-6 text-sm">منتج هـ: <span className="font-code text-red-500">٣٣٫١٥ ل.س <TrendingUp className="inline h-4 w-4 transform rotate-180" /></span></span>
